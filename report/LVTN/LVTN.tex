...
% Required to create new blank page
...
\renewcommand{\lstlistingname}{\textbf{Mã nguồn}}% Listing -> Code
\renewcommand{\lstlistlistingname}{Danh sách \lstlistingname}% List of Listings -> List of Code
