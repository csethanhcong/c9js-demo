...
%----------------------------------%
\subsubsection{Semantic Versioning (1.5)}
%----------------------------------%

%----------------------------------%
%----------------------------------%
\subsubsection{CI-CD (1.5)}
...
Đối với Map, C9js phân biệt hai loại đối tượng (\textit{Object}) như sau:
...
\item createLayerFromGeojson(\textit{url, data, style}): Tương tự như hàm createObject() nhưng ở đây có thêm tham số \textit{url} cho phép người dùng tải tập tin GeoJSON để liên kết với dữ liệu đầu vào.
	\begin{list}{}{}
...
%----------------------------------------------%
\newpage
\section{Hiện thực thư viện (12)}
\subsection{Kiến trúc xây dựng (7)}
...
Đối với thành phần Chart, có một \textit{Base Class} là \textit{Chart} sẽ bao gồm:
\begin{list}{}{}
...
(định nghĩa)
(Luồng phát sinh dữ liệu callback) hình
